...
join muscle_groups mg on (
  ...
  (e.name = 'Cable Woodchop'           and mg.slug in ('core', 'athletic')) or
  ...
  (e.name = 'Farmer''s Carry'          and mg.slug in ('core', 'athletic'))
)
on conflict do nothing;

-- ============================================================
-- SEED DEFAULT WORKOUT DAYS (Push / Pull / Glutes / Upper / Legs)
-- ============================================================
insert into workout_days (name, slug, color, subtitle, sort_order, is_custom) values
  ...
  ('Glutes', 'glutes', '#059669', 'Glutes · Quads · Calves · Core',     3, false),
  ('Upper',  'upper',  '#D97706', 'Shoulders · Arms · Core',            4, false),
  ('Legs',   'legs',   '#DC2626', 'Quads · Hamstrings · Athletic · Core', 5, false)
on conflict (slug) do nothing;
